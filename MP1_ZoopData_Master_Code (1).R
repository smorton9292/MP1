...
AIC(test.run.t1,test2.run.t1,test3.run.t1,test.run4.t1) #w tank.id is better but may not actually look at other dates // this is time point 0
...
AIC(test.run.t4,test2.run.t4,test3.run.t4,test4.run.t4) 
...
AIC(test.run.t5,test2.run.t5,test3.run.t5,test4.run.t5) #test.run.t5 is the best (all three)
...
AIC(test.run.t6,test2.run.t6,test3.run.t6,test4.run.t6) #test.run.t5 is the best (all three)
...
#Remove outlier measurement in DAP
...
#Going to work with "filtered data from Zoop.code.R script" 
#this df has counts of all taxa from all data points of interest while here we only have 0 and 97
...
AIC(measurement1.gam1,measurement1.gam2,measurement1.gam3,measurement1.gam4) #BEST MODEL IS THE LEAST COMPLICATED ONE
...
AIC(measurement4.gam1,measurement4.gam2,measurement4.gam3,measurement4.gam4) #most complicated model is the best
...
AIC(measurement5.gam1,measurement5.gam2,measurement5.gam3,measurement5.gam4) #most complicated model is the best
...
AIC(measurement6.gam1,measurement6.gam2,measurement6.gam3,measurement6.gam4) #most complicated model is the best
